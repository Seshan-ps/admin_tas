  ...
  return <SafeAreaView style={styles.container}>
      ...
      <View style={styles.switcherContainer}>
        <View style={styles.switcherTrack}>
          <TouchableOpacity onPress={handleBack} style={styles.switcherButton} activeOpacity={0.8}>
            <Text style={styles.switcherText}>Members</Text>
          </TouchableOpacity>

          <TouchableOpacity style={[styles.switcherButton, styles.switcherButtonActive]} activeOpacity={0.8}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.fieldItem}>
            ...
            <View style={styles.inputIconContainer}>
              <TextInput style={styles.textInputWithIcon} placeholder="dd/mm/yyyy" placeholderTextColor="#94a3b8" value={date} onChangeText={setDate} />
          ...
          <View style={styles.fieldItem}>
            ...
            <View style={styles.inputIconContainer}>
              <TextInput style={styles.textInputWithIcon} placeholder="00:00 AM" placeholderTextColor="#94a3b8" value={startTime} onChangeText={setStartTime} />
          ...
          <View style={styles.fieldItem}>
            ...
            <TouchableOpacity style={styles.dropdownTrigger} onPress={() => {
            Alert.alert('Select Privacy', 'Choose event visibility level', [{
              text: 'Members Only',
              onPress: () => setPrivacy('Members Only')
            }, {
              text: 'Public Access',
              onPress: () => setPrivacy('Public Access')
            }, {
              text: 'Invite Only',
          ...
          <View style={styles.fieldItem}>
            ...
            <View style={styles.inputIconContainer}>
              <TextInput style={styles.textInputWithIcon} placeholder="dd/mm/yyyy" placeholderTextColor="#94a3b8" value={deadline} onChangeText={setDeadline} />
              <Calendar size={18} color="#94a3b8" style={styles.inputIcon} />
            </View>
          </View>
