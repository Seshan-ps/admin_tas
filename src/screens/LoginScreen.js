...
export const LoginScreen = ({
  ...
  return <SafeAreaView className="flex-1 bg-white relative">
      ...
      }} showsVerticalScrollIndicator={true} className="px-6 py-8">
          {/* Logo Header */}
          ...
          borderColor: 'rgba(219, 234, 254, 0.6)'
            ...
            <View className="mb-4">
              ...
              borderColor: '#AEC8E8'
                ...
                <TextInput value={username} onChangeText={setUsername} placeholder="Enter username" placeholderTextColor="#94a3b8" autoCapitalize="none" className="flex-1 text-slate-800 text-[15px] p-0" style={Platform.OS === 'web' ? {
                outlineStyle: 'none',
                borderStyle: 'none'
              } : undefined} />
              </View>
            ...
            <View className="mb-5">
              ...
              borderColor: '#AEC8E8'
                ...
                <TextInput value={password} onChangeText={setPassword} placeholder="Enter Password" placeholderTextColor="#94a3b8" secureTextEntry={!showPassword} autoCapitalize="none" className="flex-1 text-slate-800 text-[15px] p-0 pr-8" style={Platform.OS === 'web' ? {
                outlineStyle: 'none',
                borderStyle: 'none'
              } : undefined} />
            ...
            {/* Error Banner */}
            {errorMessage ? <View className="bg-[#D99A9A]/90 border border-red-300 rounded-xl p-3 flex-row items-center mb-5 space-x-3">
