...
export const AnalyticsScreen: React.FC<AnalyticsScreenProps> = ({ onBack, onTabPress, navigation }) => {
  ...
  const renderDonutChart = () => {
    const segments = [
      { percentage: analyticsData.distribution.platinum, color: '#0D3866' }, // Platinum Fellow
      { percentage: analyticsData.distribution.senior, color: '#70B62C' }, // Senior Associate
      { percentage: analyticsData.distribution.associate, color: '#1D4ED8' }, // Associate
      { percentage: analyticsData.distribution.student, color: '#DBEAFE' }, // Student
    ];
  ...
  const renderGeneralView = () => {
    const barData = [
      { day: 'Mon', val: 50, green: false },
      { day: 'Tue', val: 10, green: false },
      { day: 'Wed', val: 35, green: false },
      { day: 'Thu', val: 48, green: false },
      { day: 'Fri', val: 72, green: true, label: '8hrs' },
      { day: 'Sat', val: 35, green: false },
      { day: 'Sun', val: 52, green: false },
    ];
    ...
    return (
      <View style={styles.tabContentContainer}>
          ...
          <View style={styles.cardHeaderRow}>
            ...
            <View style={styles.periodSwitcherTrack}>
              <TouchableOpacity
                ...
                style={[styles.periodSwitcherBtn, usagePeriod === 'monthly' && styles.periodSwitcherBtnActive]}
              >
              ...
              <TouchableOpacity
                ...
                style={[styles.periodSwitcherBtn, usagePeriod === 'weekly' && styles.periodSwitcherBtnActive]}
              >
          ...
          <View style={styles.configContentBlock}>
            ...
            <View style={styles.configRowSpacing}>
              ...
              <View style={styles.progressBarBg}>
                <View style={[styles.progressBarFill, { width: '99.9%' }]} />
              </View>
            </View>
        ...
        <View style={[styles.cardContainer, { marginBottom: 120 }]}>
  ...
  const renderMembershipsView = () => {
    ...
    const tierData = [
      { tier: 'Lifetime', count: Math.round(totalCountVal * 0.0667).toLocaleString() },
      { tier: 'Premium', count: Math.round(totalCountVal * 0.5333).toLocaleString() },
      { tier: 'Professional', count: Math.round(totalCountVal * 0.20).toLocaleString() },
      { tier: 'Basic', count: Math.round(totalCountVal * 0.20).toLocaleString() },
    ];
      ...
      <View style={styles.tabContentContainer}>
        ...
        <View style={styles.tierListSection}>
          {tierData.map((item, idx) => (
            <View key={idx} style={styles.tierRowCard}>
        ...
        <View style={styles.sectionHeaderSpacing}>
          ...
          <TouchableOpacity style={styles.dropdownSelector} activeOpacity={0.8}>
            <Calendar size={15} color="#0D3866" style={{ marginRight: 8 }} />
            <Text style={styles.dropdownText}>Last 6 Months</Text>
            <ChevronDown size={14} color="#0D3866" style={{ marginLeft: 'auto' }} />
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.kpiContainer}>
          ...
          <View style={[styles.kpiCard, { borderLeftColor: '#0D3866' }]}>
          ...
          <View style={[styles.kpiCard, { borderLeftColor: '#70B62C' }]}>
            <View style={styles.kpiHeader}>
          ...
          {/* Card 3: New Sales */}
          <View style={[styles.kpiCard, { borderLeftColor: '#475569' }]}>
            <View style={styles.kpiHeader}>
        ...
        <View style={styles.cardContainer}>
          ...
          <View style={styles.donutLegendContainer}>
            {[
              { label: 'Platinum Fellow', val: `${analyticsData.distribution.platinum}%`, color: '#0D3866' },
              { label: 'Senior Associate', val: `${analyticsData.distribution.senior}%`, color: '#70B62C' },
              { label: 'Associate', val: `${analyticsData.distribution.associate}%`, color: '#1D4ED8' },
              { label: 'Student', val: `${analyticsData.distribution.student}%`, color: '#DBEAFE' },
            ].map((leg, idx) => (
              <View key={idx} style={styles.donutLegendItem}>
                <View style={styles.legendLabelRow}>
                  <View style={[styles.legendIndicatorColor, { backgroundColor: leg.color }]} />
        ...
        <View style={[styles.cardContainer, { marginBottom: 140 }]}>
          <Text style={styles.cardTitle}>Recent Activity</Text>
          <View style={styles.activityList}>
            {[
              { name: 'Julian Sterling', time: 'Joined 45 mins ago', badge: 'Lifetime', avatar: require('../../assets/admin_profile.png') },
              { name: 'Sarah Chen', time: 'Joined 2 hours ago', badge: 'Premium', avatar: require('../../assets/elena_profile.png') },
              { name: 'Marcus Thorne', time: 'Joined 5 hours ago', badge: 'Basic', avatar: require('../../assets/admin_profile.png') },
            ].map((act, index) => (
              <View key={index} style={[styles.activityItem, index === 2 && { borderBottomWidth: 0 }]}>
                <Image source={act.avatar} style={styles.activityAvatar as any} />
      ...
      <View style={styles.headerContainer}>
        ...
        <View style={styles.tabSwitcherOuter}>
          <TouchableOpacity
            ...
            style={[styles.tabSwitcherBtn, activeSegment === 'general' && styles.tabSwitcherBtnActive]}
          >
          ...
          <TouchableOpacity
            ...
            style={[styles.tabSwitcherBtn, activeSegment === 'memberships' && styles.tabSwitcherBtnActive]}
          >
